...
<jsp:setProperty name="item1"  property="itemID"  value='tablets1' />
<jsp:setProperty name="item2"  property="itemID"  value='tablets2' />
<jsp:setProperty name="item3"  property="itemID"  value='tablets3' />
<jsp:setProperty name="item4"  property="itemID"  value='tablets4' />
<jsp:setProperty name="item5"  property="itemID"  value='tablets5' />
<BR>

...
<jsp:setProperty name="item1"  property="itemID"  value='tv1' />
<jsp:setProperty name="item2"  property="itemID"  value='tv2' />
<jsp:setProperty name="item3"  property="itemID"  value='tv3' />
<BR>
